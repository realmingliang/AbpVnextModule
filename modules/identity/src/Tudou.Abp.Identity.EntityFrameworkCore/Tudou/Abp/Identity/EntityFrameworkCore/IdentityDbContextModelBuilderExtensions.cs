    ...
    public static class IdentityDbContextModelBuilderExtensions
    {
            ...
            [CanBeNull] Action<IdentityModelBuilderConfigurationOptions> optionsAction = null)
        {
            ...
            builder.Entity<OrganizationUnit>(b =>
            {
                ...
                b.ConfigureConcurrencyStamp();
                b.ConfigureFullAuditedAggregateRoot();
                b.Property(uc => uc.DisplayName).HasMaxLength(OrganizationUnitConsts.MaxDisplayNameLength).IsRequired(); // make unique
                b.Property(uc => uc.ConcurrencyStamp).IsRequired().IsConcurrencyToken().HasMaxLength(IdentityClaimTypeConsts.MaxConcurrencyStampLength).HasColumnName(nameof(IdentityClaimType.ConcurrencyStamp));
            });
            builder.Entity<OrganizationUnitRole>(b =>
            {
                ...
                b.HasIndex(ur => new { ur.OrganizationUnitId, ur.RoleId });
            });
            ...
            builder.Entity<IdentityUserOrganizationUnit>(b =>
            {
                ...
                b.HasOne<IdentityUser>().WithMany().HasForeignKey(uo => uo.UserId).IsRequired();
                b.HasOne<OrganizationUnit>().WithMany().HasForeignKey(uo => uo.OrganizationUnitId).IsRequired();
                b.HasIndex(uo => new { uo.OrganizationUnitId, uo.UserId });
