...
using Tudou.Abp.Account.Web.Areas.Account.Controllers.Models;
using Tudou.Abp.Identity;
using SignInResult = Microsoft.AspNetCore.Identity.SignInResult;
using UserLoginInfo = Tudou.Abp.Account.Web.Areas.Account.Controllers.Models.UserLoginInfo;
using IdentityUser = Tudou.Abp.Identity.IdentityUser;
using Volo.Abp;
using Volo.Abp.AspNetCore.Mvc;
using Volo.Abp.Settings;
using Volo.Abp.Validation;

namespace Tudou.Abp.Account.Web.Areas.Account.Controllers
{
    [RemoteService]
    [Controller]
